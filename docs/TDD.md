...
│   └── e2e/                  → Playwright E2E tests (chromium + firefox + mobile-chrome, 22 spec files including timezone/calendar, grade-release, feedback-snippet, and intervention workflow coverage, includes @axe-core/playwright a11y scans)
├── docker/
│   └── Dockerfile
├── drizzle.config.ts
├── package.json
