...
│   └── e2e/                  → Playwright E2E tests (chromium + firefox + mobile-chrome, including TRACK-049 management and review-picker coverage, plus @axe-core/playwright scans)
├── docker/
│   └── Dockerfile
├── drizzle.config.ts
├── package.json
...
- Chromium, Firefox, and mobile Chromium projects, `workers: 1` (serial execution for DB isolation).
