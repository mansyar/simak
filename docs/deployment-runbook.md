...
- successful application of risk-history review migration `0034_smart_quentin_quire.sql`, which permits expired observations to clear lifecycle event/source details during anonymization;
