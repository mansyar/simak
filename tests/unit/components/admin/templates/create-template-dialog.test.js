  ...
  CheckpointListEditor: ({
    ...
    _jsxs('div', {
      ...
      children: [
        ...
        _jsx('button', {
          'data-testid': 'btn-remove-0',
          onClick: () => onRemove(0),
          children: 'Remove 0',
        }),
        _jsx('button', {
          'data-testid': 'btn-remove-1',
          onClick: () => onRemove(1),
          children: 'Remove 1',
        }),
        _jsx('button', {
          'data-testid': 'btn-move-up-0',
          onClick: () => onMoveUp(0),
          children: 'MoveUp 0',
        }),
        _jsx('button', {
          'data-testid': 'btn-move-up-1',
          onClick: () => onMoveUp(1),
          children: 'MoveUp 1',
        }),
        _jsx('button', {
          'data-testid': 'btn-move-down-0',
          onClick: () => onMoveDown(0),
          children: 'MoveDown 0',
        }),
        _jsx('button', {
          'data-testid': 'btn-move-down-2',
          onClick: () => onMoveDown(2),
          children: 'MoveDown 2',
        }),
        _jsx('button', {
          'data-testid': 'btn-change-0',
          onClick: () => onChange(0, 'Updated'),
          children: 'Change 0',
        }),
        _jsx('button', {
          'data-testid': 'btn-min-cons-0',
          onClick: () => onMinConsultationsChange(0, 2),
          children: 'MinCons 0',
        }),
        _jsx('button', {
          'data-testid': 'btn-est-dur-0',
          onClick: () => onEstimatedDurationChange(0, 14),
          children: 'EstDur 0',
        }),
      ],
    }),
...
vi.mock('@/components/ui/form', () => ({
  ...
  FormLabel: ({ children }) => _jsx('label', { 'data-testid': 'form-label', children: children }),
...
vi.mock('@/components/ui/button', () => ({
  Button: ({ children, type, onClick, ...props }) =>
    _jsx('button', { type: type || 'button', onClick: onClick, ...props, children: children }),
}));
...
describe('CreateTemplateDialog', () => {
  ...
  beforeEach(() => {
    ...
    mockFormMethods.handleSubmit.mockImplementation((cb) => async () => {
      await cb({
        name: 'New Template',
        type: 'Thesis',
