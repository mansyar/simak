...
describe('CheckpointListEditor', () => {
  ...
  it('should render all checkpoints', () => {
    render(_jsx(CheckpointListEditor, { ...defaultProps }));
  ...
  it('should disable Move Up on first checkpoint', () => {
    render(_jsx(CheckpointListEditor, { ...defaultProps }));
    expect(screen.getAllByLabelText('Move Up')[0].disabled).toBe(true);
  });
  ...
  it('should show error text when errors prop is provided', () => {
    render(
      _jsx(CheckpointListEditor, { ...defaultProps, errors: [undefined, 'Required', undefined] }),
    );
  ...
  it('should disable Remove when only one checkpoint', () => {
    ...
    expect(screen.getByLabelText('Remove').disabled).toBe(true);
  });
