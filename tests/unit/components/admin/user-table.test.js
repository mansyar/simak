...
vi.mock('@/components/ui/dropdown-menu', () => ({
  ...
  DropdownMenuItem: ({ children, onClick }) =>
    _jsx('button', { 'data-testid': 'dropdown-item', onClick: onClick, children: children }),
  DropdownMenuTrigger: ({ children, ...props }) =>
    _jsx('button', { 'data-testid': 'dropdown-trigger', ...props, children: children }),
  DropdownMenuGroup: ({ children }) => _jsx('div', { children: children }),
  DropdownMenuLabel: ({ children }) => _jsx('div', { children: children }),
  DropdownMenuSeparator: () => _jsx('hr', {}),
}));
// Mock useI18n
