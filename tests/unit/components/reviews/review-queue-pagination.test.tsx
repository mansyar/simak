...
describe('ReviewQueuePagination', () => {
  ...
  it('should disable next button on last page', () => {
    render(<ReviewQueuePagination currentPage={5} totalPages={5} onPageChange={() => {}} />);
    const buttons = screen.getAllByRole('button');
  ...
  it('should call onPageChange with next page', () => {
    ...
    render(<ReviewQueuePagination currentPage={1} totalPages={5} onPageChange={onPageChange} />);
    const buttons = screen.getAllByRole('button');
    const nextButton = buttons[buttons.length - 1];
  ...
  it('should call onPageChange with previous page', () => {
    const onPageChange = vi.fn();
    render(<ReviewQueuePagination currentPage={3} totalPages={5} onPageChange={onPageChange} />);
    const buttons = screen.getAllByRole('button');
    const prevButton = buttons[0];
