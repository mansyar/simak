...
describe('TemplatePicker', () => {
  ...
  it('should render loading skeleton initially and load templates', async () => {
    render(_jsx(TemplatePicker, { selectedTemplateId: null, onSelectTemplate: onSelectTemplate }));
  ...
  it('should show the milestones roadmap preview when template is selected', async () => {
    render(_jsx(TemplatePicker, { selectedTemplateId: 1, onSelectTemplate: onSelectTemplate }));
    await waitFor(() => {
