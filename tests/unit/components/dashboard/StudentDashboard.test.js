...
vi.mock('lucide-react', () => ({
  Clock: () => _jsx('div', { 'data-testid': 'clock-icon' }),
  FileText: () => _jsx('div', { 'data-testid': 'file-text-icon' }),
  MessageSquare: () => _jsx('div', { 'data-testid': 'message-square-icon' }),
  ClipboardList: () => _jsx('div', { 'data-testid': 'clipboard-list-icon' }),
}));
...
describe('StudentDashboard', () => {
  ...
  it('should render error state', () => {
    ...
    render(_jsx(StudentDashboard, { data: data }));
  ...
  it('should use Progress component for active assignments', () => {
    ...
    const { container } = render(_jsx(StudentDashboard, { data: data }));
