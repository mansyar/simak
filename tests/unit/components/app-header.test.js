...
vi.mock('@/components/layout/theme-toggle', () => ({
  ThemeToggle: () => _jsx('div', { 'data-testid': 'theme-toggle' }),
}));
vi.mock('@/components/layout/language-switcher', () => ({
  LanguageSwitcher: () => _jsx('div', { 'data-testid': 'language-switcher' }),
}));
vi.mock('@/components/notifications/NotificationBadge', () => ({
  NotificationBadge: ({ onOpen }) =>
    _jsx('button', {
...
describe('AppHeader', () => {
  ...
  it('should render mobile menu toggle button', () => {
    render(_jsx(AppHeader, { onMenuToggle: vi.fn(), onNotificationOpen: vi.fn() }));
    const menuButton = screen.getByLabelText('common.openMenu');
    expect(menuButton).toBeDefined();
  });
  it('should call onMenuToggle when menu button clicked', () => {
    const mockToggle = vi.fn();
    render(_jsx(AppHeader, { onMenuToggle: mockToggle, onNotificationOpen: vi.fn() }));
    const menuButton = screen.getByLabelText('common.openMenu');
  ...
  it('should call onNotificationOpen when notification badge clicked', () => {
    ...
    render(_jsx(AppHeader, { onMenuToggle: vi.fn(), onNotificationOpen: mockOpen }));
