...
describe('User server functions - Logic & Security', () => {
  ...
  describe('getUser', () => {
    ...
    it('should return user for admin', async () => {
      ...
      mockDb.then.mockImplementationOnce((fn) =>
        Promise.resolve([
  ...
  describe('updateUser', () => {
    ...
    it('should update user successfully', async () => {
      ...
      mockDb.then.mockImplementationOnce((fn) => Promise.resolve([]).then(fn));
      const result = await updateUserHandler({
    ...
    it('should reject duplicate email', async () => {
      ...
      mockDb.then.mockImplementationOnce((fn) => Promise.resolve([{ id: 'other-user' }]).then(fn));
      const result = await updateUserHandler({
