...
vi.mock('@tanstack/react-start', () => ({
  ...
  createMiddleware: vi.fn().mockReturnValue({
    server: vi.fn().mockImplementation((fn: any) => fn),
  }),
...
vi.mock('@/components/instructor/assignments/AssignmentCard', () => ({
  AssignmentCard: () => <div data-testid="assignment-card" />,
}));
vi.mock('@/components/instructor/assignments/AssignmentFilters', () => ({
  AssignmentFilters: () => <div data-testid="assignment-filters" />,
}));
vi.mock('@/components/instructor/assignments/AssignmentEmptyState', () => ({
  AssignmentEmptyState: () => <div data-testid="assignment-empty-state" />,
}));
vi.mock('@/components/instructor/assignments/AssignmentLoadingSkeleton', () => ({
  AssignmentLoadingSkeleton: () => <div data-testid="assignment-loading-skeleton" />,
}));
vi.mock('@/components/instructor/assignments/AssignmentWizard', () => ({
  AssignmentWizard: () => <div data-testid="assignment-wizard" />,
}));
vi.mock('@/components/admin/templates/TemplatePagination', () => ({
  TemplatePagination: () => <div data-testid="template-pagination" />,
}));
vi.mock('@/components/reviews/ReviewQueueTable', () => ({
  ReviewQueueTable: () => <div data-testid="review-queue-table" />,
}));
vi.mock('@/components/reviews/ReviewQueueFilters', () => ({
  ReviewQueueFilters: () => <div data-testid="review-queue-filters" />,
}));
vi.mock('@/components/reviews/ReviewQueueEmptyState', () => ({
  ReviewQueueEmptyState: () => <div data-testid="review-queue-empty-state" />,
}));
...
vi.mock('@/components/reviews/ReviewQueuePagination', () => ({
  ReviewQueuePagination: () => <div data-testid="review-queue-pagination" />,
}));
vi.mock('@/components/reviews/ReviewDetailHeader', () => ({
  ReviewDetailHeader: ({ studentName }: any) => (
    <div data-testid="review-detail-header">
