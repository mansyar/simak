...
vi.mock('@tanstack/react-router', () => ({
  ...
  createFileRoute: vi.fn().mockReturnValue((config) => ({
    ...config,
...
vi.mock('@/server/instructor-assignments-filter', () => ({
  listInstructorAssignmentsForFilter: (...args) => mockListInstructorAssignmentsForFilter(...args),
}));
// Mock __root
...
let capturedFiltersProps = undefined;
vi.mock('@/components/reviews/ReviewQueueFilters', () => ({
  ReviewQueueFilters: vi.fn().mockImplementation((props) => {
