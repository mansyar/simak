...
- [x] Task: Add optimistic updates to `useMarkRead` hook (SHA: 4f9e1ab)
    ...
    - [x] Run `pnpm test` — confirm tests pass
- [x] Task: Add optimistic updates to `useMarkAllRead` hook (SHA: 2e7a9c0)
...
- [x] Task: Add optimistic updates to `verifyConsultation` hook (after Phase 0 refactor) [f2ac940]
    ...
    - [x] Run `pnpm test` — confirm tests pass
- [x] Task: Add optimistic updates to `rejectConsultation` hook (after Phase 0 refactor) [b99943f]
...
- [x] Task: Add optimistic updates to `approveExtension` hook (after Phase 0 refactor) [64d2d1d]
    ...
    - [x] Run `pnpm test` — confirm tests pass
- [x] Task: Add optimistic updates to `rejectExtension` hook (after Phase 0 refactor) [3c024d6]
    - [x] Write failing tests — verify `onMutate` removes from pending extension queue optimistically; `onError` restores snapshot + shows `toast.error()`; `onSettled` invalidates
