...
- [ ] Task: Re-read the approved `spec.md` and `conductor/workflow.md`
  - [ ] Confirm the 100/50/2,000 character limits, ownership model, archive/restore lifecycle, and no-hard-delete rule.
  - [ ] Confirm the migration, test, commit, and git-note requirements.
