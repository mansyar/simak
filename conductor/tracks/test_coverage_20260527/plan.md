...
- [x] Task: Write unit tests for `src/server/consultations.ts` (40% → >80%)
  - [x] Analyze uncovered lines (77-93)
...
- [x] Task: Write unit tests for `src/server/submissions.ts` (40% → >80%)
  - [x] Analyze uncovered lines (23-41)
  - [x] Write tests for Zod schemas
  - [x] Write tests for server function stubs
  - [x] Run tests and verify coverage increase

- [x] Task: Write unit tests for `src/server/templates.ts` (38% → >80%)
  - [x] Analyze uncovered lines (68-84)
  - [x] Write tests for Zod schemas
  - [x] Write tests for server function stubs
  - [x] Run tests and verify coverage increase

- [x] Task: Write unit tests for `src/server/users.ts` (40% → >80%)
  - [x] Analyze uncovered lines (55-71)
  - [x] Write tests for Zod schemas
  - [x] Write tests for server function stubs
  - [x] Run tests and verify coverage increase
...
## Phase 6: Threshold Update & Final Verification [checkpoint: 7c523ff]
