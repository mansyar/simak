-- WARNING: only valid after all expired report jobs have been finalized. Rows in state 'expired' that still retain an artifact key violate the restored constraint.
