...
import { getStudentAcademicRecords, type AcademicRecordsResult } from '@/server/academic-records';
...
export const Route = createFileRoute('/_authenticated/student/academic-records')({
  ...
  loader: ({ deps }) => getStudentAcademicRecords({ data: deps }),
  pendingComponent: AcademicRecordsLoading,
  component: StudentAcademicRecordsRoute,
});
