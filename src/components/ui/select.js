...
function SelectGroup({ className, ...props }) {
  return _jsx(SelectPrimitive.Group, {
...
function SelectValue({ className, ...props }) {
  return _jsx(SelectPrimitive.Value, {
...
function SelectContent({
  ...
  return _jsx(SelectPrimitive.Portal, {
    children: _jsx(SelectPrimitive.Positioner, {
      ...
      children: _jsxs(SelectPrimitive.Popup, {
        ...
        children: [
          ...
          _jsx(SelectPrimitive.List, { children: children }),
  ...
  return _jsxs(SelectPrimitive.Item, {
    ...
    children: [
      ...
      _jsx(SelectPrimitive.ItemIndicator, {
        ...
        children: _jsx(CheckIcon, { className: 'pointer-events-none' }),
      }),
    ],
  });
}
...
function SelectScrollUpButton({ className, ...props }) {
  return _jsx(SelectPrimitive.ScrollUpArrow, {
    ...
    ...props,
    children: _jsx(ChevronUpIcon, {}),
  });
}
function SelectScrollDownButton({ className, ...props }) {
  return _jsx(SelectPrimitive.ScrollDownArrow, {
