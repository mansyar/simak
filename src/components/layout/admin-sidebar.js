...
export function AdminSidebar({ isOpen, onClose }) {
  ...
  const preferenceLinks = [{ to: '/admin/settings', label: 'nav.settings', icon: Settings }];
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('span', {
                    ...
                    children: t('adminSidebar.branding'),
                  }),
                ],
              }),
              _jsx('button', {
          ...
          _jsxs('nav', {
            ...
            children: [
              _jsx('span', {
                ...
                children: t('adminSidebar.sectionMain'),
              }),
              mainLinks.map((link) => {
              ...
              _jsx('span', {
                ...
                children: t('adminSidebar.sectionPreferences'),
              }),
