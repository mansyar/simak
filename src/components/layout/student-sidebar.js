...
export function StudentSidebar({ isOpen, onClose }) {
  ...
  const preferenceLinks = [
    { to: '/student/settings', label: 'studentSidebar.settings', icon: Settings },
  ];
              ...
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsx('span', {
                    ...
                    children: t('studentSidebar.branding'),
                  }),
                ],
              }),
              _jsx('button', {
          ...
          _jsxs('nav', {
            ...
            children: [
              _jsx('span', {
                ...
                children: t('studentSidebar.sectionMain'),
              }),
              mainLinks.map((link) => {
              ...
              _jsx('span', {
                ...
                children: t('studentSidebar.sectionPreferences'),
              }),
