...
export async function seedTestUsers() {
  ...
  const testUsers = [
    { name: 'Instructor', email: 'instructor@simak.app', role: 'instructor' },
    { name: 'Student', email: 'student@simak.app', role: 'student' },
  ];
 ...
 */
export async function seedTestTemplatesAndAssignments() {
  const db = getDb();
  // Find test users
