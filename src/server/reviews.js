...
export const listPendingReviews = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const getReviewDetail = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const openForReview = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const submitReview = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const getLatestReview = createServerFn({ method: 'GET' }).handler(async (args) => {
