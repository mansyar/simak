...
export const getPresignedUploadUrl = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const getPresignedDownloadUrl = createServerFn({ method: 'GET' }).handler(async (args) => {
