 ...
 */
export async function generateTwoFactorSetupHandler(args) {
 ...
 */
export async function enableTwoFactorHandler(args) {
  const session = await getSessionFromHeaders();
  if (!session) {
    return { error: 'Unauthorized' };
  }
 ...
 */
export async function disableTwoFactorHandler(args) {
  const session = await getSessionFromHeaders();
  if (!session) {
    return { error: 'Unauthorized' };
  }
 ...
 */
export async function regenerateBackupCodesHandler(args) {
  const session = await getSessionFromHeaders();
  if (!session) {
    return { error: 'Unauthorized' };
  }
 ...
 */
export async function getTwoFactorStatusHandler(_args) {
  const session = await getSessionFromHeaders();
  if (!session) {
    return { error: 'Unauthorized' };
  }
