...
export const createAssignment = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const listInstructorAssignments = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const getAssignmentDetail = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const listStudentAssignments = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const unlockCheckpoint = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const extendDeadline = createServerFn({ method: 'POST' }).handler(async (args) => {
