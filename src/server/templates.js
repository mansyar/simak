...
export const listTemplates = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const getTemplate = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const createTemplate = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const updateTemplate = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const deleteTemplate = createServerFn({ method: 'POST' }).handler(async (args) => {
  const { deleteTemplateHandler } = await import('./templates.server');
  const data = TemplateIdParamSchema.parse(args.data);
  return deleteTemplateHandler({ data });
});
export const duplicateTemplate = createServerFn({ method: 'POST' }).handler(async (args) => {
  const { duplicateTemplateHandler } = await import('./templates.server');
  const data = TemplateIdParamSchema.parse(args.data);
  return duplicateTemplateHandler({ data });
});
export const listTemplateAssignments = createServerFn({ method: 'GET' }).handler(async (args) => {
