 ...
 */
export async function logConsultationHandler(args) {
 ...
 */
export async function listConsultationsHandler(args) {
  const session = await getSessionFromHeaders();
  if (!session) {
    return { error: 'Unauthorized' };
  }
 ...
 */
export async function getConsultationDetailHandler(args) {
  const session = await getSessionFromHeaders();
 ...
 */
export async function verifyConsultationHandler(args) {
  const session = await getSessionFromHeaders();
  if (!isInstructor(session)) {
    return { error: 'Unauthorized' };
  }
 ...
 */
export async function rejectConsultationHandler(args) {
  const session = await getSessionFromHeaders();
  if (!isInstructor(session)) {
    return { error: 'Unauthorized' };
  }
