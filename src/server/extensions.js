...
export const requestExtension = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const listExtensionRequests = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const listMyExtensionRequests = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const approveExtension = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const rejectExtension = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const bulkExtend = createServerFn({ method: 'POST' }).handler(async (args) => {
