...
export const generateTwoFactorSetup = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const enableTwoFactor = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const disableTwoFactor = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const regenerateBackupCodes = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const getTwoFactorStatus = createServerFn({ method: 'GET' }).handler(async (args) => {
