...
export const getPresignedUploadUrl = typedServerFn({ method: 'GET' }).handler(
...
export const getPresignedDownloadUrl = typedServerFn({ method: 'GET' }).handler(
  async (args: { data: unknown }) => {
...
export const getPresignedReviewFeedbackUploadUrl = typedServerFn({ method: 'GET' }).handler(
  async (args: { data: unknown }) => {
