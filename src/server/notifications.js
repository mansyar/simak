...
export const createNotification = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const listNotifications = createServerFn({ method: 'GET' }).handler(async (args) => {
...
export const markRead = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const markAllRead = createServerFn({ method: 'POST' }).handler(async (args) => {
...
export const getUnreadCount = createServerFn({ method: 'GET' }).handler(async (args) => {
